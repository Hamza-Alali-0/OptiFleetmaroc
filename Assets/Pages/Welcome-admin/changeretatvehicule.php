...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql_check_existence = "SELECT * FROM etatvehicule WHERE idvehicule=?";
    ...
    if ($result_existence->num_rows > 0) {
        // Update vehicle details if vehicle exists
        $stmt = $conn->prepare("UPDATE etatvehicule SET composants=?, huile=?, liquide=?, kilometrage=? WHERE idvehicule=?");
        $stmt->bind_param("sssss", $c, $h, $l, $k, $id); // Assuming the data types are string (s) for all fields
        if ($stmt->execute()) {
        ...
        $email_error = "Véhicule non trouvé";
    }
    $conn->close();
}
?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center ftco-animate">
            <h2 class="text-uppercase ftco-uppercase">Modifier l'Etat du Vehicule</h2>
        ...
        <div class="row">
          <div class="col-md bg-white p-5 m-2 text-center mb-2 ftco-animate">
            <div class="ftco-pricing">
              ...
              <br><br>
            <legend>Entrer etat composants </legend>
              <input type="text" value="" name="c">
              <br><br>
            <legend>Entrer etat niveau de huile </legend>
              <input type="text" value="" name="h">
              <br><br>
              <legend>Entrer etat de liquide </legend>
              <input type="text" value="" name="l">
              <br><br>
              <legend>Entrer  kilometrage </legend>
