      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center ftco-animate">
            <h2 class="text-uppercase ftco-uppercase"> Etat des Vehicules</h2>
...
$q = $cnx->prepare("SELECT * FROM etatvehicule");
$q->execute();
    ...
    <table>
        ...
        <?php foreach($tab as $row): ?>
            <tr>
                ...
                <td><?php echo $row['composants']; ?></td>
                <td><?php echo $row['huile']; ?></td>
                <td><?php echo $row['liquide']; ?></td>
