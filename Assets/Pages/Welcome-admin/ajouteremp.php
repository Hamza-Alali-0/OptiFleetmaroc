...
if (mysqli_num_rows($res) > 0) {
  ...
  if($email==isset($row['email']))
  {
    ...
    $stmt = $conn->prepare("insert into employee(email,password) values(?,?)");
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center ftco-animate">
            <h2 class="text-uppercase ftco-uppercase">Ajouter l'Employee</h2>
        ...
        <div class="row">
          <div class="col-md bg-white p-5 m-2 text-center mb-2 ftco-animate">
            ...
            <form action="" method="post">
              ...
              <br><br>
              <legend>Entrer Mot de passe </legend>
