...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    $email = $_POST['email'];
    $sql = "SELECT * FROM vehicule WHERE matricule='$email'";
    $res = mysqli_query($conn, $sql);
    if (mysqli_num_rows($res) > 0) {
        $stmt = $conn->prepare("DELETE FROM vehicule WHERE matricule=?");
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center ftco-animate">
            <h2 class="text-uppercase ftco-uppercase">Supprimer le Vehicule</h2>
        ...
        <div class="row">
          <div class="col-md bg-white p-5 m-2 text-center mb-2 ftco-animate">
            ...
            <legend>Entrer Matricule du vehicule a Supprimer </legend>
