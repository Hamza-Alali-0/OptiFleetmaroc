...
if (mysqli_num_rows($res) > 0) {
  ...
  if($email==isset($row['email']))
  {
    ...
    $stmt = $conn->prepare("insert into conducteurs values(?,?,?,?,?)");
    $stmt->bind_param("sssss",$nom,$prenom,$email, $CIN,$experience);
    $stmt->execute();
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center ftco-animate">
            <h2 class="text-uppercase ftco-uppercase">Ajouter le Conducteur</h2>
