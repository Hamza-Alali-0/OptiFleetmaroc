...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    $email = $_POST['email'];
    $sql = "SELECT * FROM conducteurs WHERE email='$email'";
    $res = mysqli_query($conn, $sql);
    if (mysqli_num_rows($res) > 0) {
        $stmt = $conn->prepare("DELETE FROM conducteurs WHERE email=?");
        $stmt->bind_param("s", $email);
        $stmt->execute();
        $email_error = "Supprimé avec succès";
        $stmt->close();
    } else {
  ...
  <body data-spy="scroll" data-target="#ftco-navbar" data-offset="200">
   ...
   <!-- Ajouteremployee -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center ftco-animate">
            <h2 class="text-uppercase ftco-uppercase">Supprimer le Conducteur</h2>
        ...
        <div class="row">
          <div class="col-md bg-white p-5 m-2 text-center mb-2 ftco-animate">
            ...
            <legend>Entrer Email du conducteur a Supprimer </legend>
    ...
    <footer style="color: white; background-color: black;">
            ...
            <p> &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &copy 2024. Optifleet-Maroc <span ></span>  </p>
